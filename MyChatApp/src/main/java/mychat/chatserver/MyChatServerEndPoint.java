...
public class MyChatServerEndPoint {
	...
	public void closeWS(Session userSession) throws IOException {
		...
		while(iterator.hasNext()) {
			...
			otherSession.getBasicRemote().sendText(buildCountJson(count));
		}
	}
